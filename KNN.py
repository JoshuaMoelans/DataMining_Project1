...
def read_existing_customers_KNN(data):
    """
    Read the existing customers data and return a KNN classifier
    :param data:
    :return: classifier, score, estimated profit, recall%, feature_cols
    """
...
def test_knn_approach(data):
    all_scores = []
    all_profits = []
    all_precisions = []
    for i in range(25):
        _, score, profit, precision, fc = read_existing_customers_KNN(data)
...
def predict_ROI_KNN(data):
    clf, score, profit, precision, fc = read_existing_customers_KNN(data)
